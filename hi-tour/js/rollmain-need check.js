 //이미지 슬라이드 구현
let num=0;  //이미지, 버튼 번호
let slidingAuto = null;   //슬라이드 기능을 작동하게하는 변수(객체이므로 null로 처리. 숫자면 0.)
...
//일정시간 간격으로 작동 (호출)
slidingAuto = setTimeout("play('right')", 3000);  //슬라이드를 3초간격으로 작동시킴
...
$(function(){
	...
	$(".rollstop a").click(function(){
		...
		$(".rollplay").css("display","inline-block"); //재생버튼이 보임
